...
function d2hImageCandidates(kind,slug,exact=''){const base=kind==='heroes'?`/apps/dota2/images/dota_react/heroes/${slug}.png`:`/apps/dota2/images/dota_react/items/${slug}.png`;const out=[];if(exact&&/^https?:\/\//.test(exact))out.push(exact.split('?')[0]);['https://cdn.cloudflare.steamstatic.com','https://cdn.akamai.steamstatic.com','https://cdn.steamstatic.com','https://cdn.dota2.com'].forEach(h=>out.push(h+base));return [...new Set(out)];}
