...
function popularityCard(phase,arr){
  // OpenDota в itemPopularity отдаёт только счётчик покупок, без побед.
  // При проверке wins>=0 у каждого предмета печаталось «0.0% побед» — то есть
  // выдуманный ноль вместо честного «данных нет».
