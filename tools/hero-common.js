// Общие справочники и помощники по героям для сборщиков страниц.
//
// Раньше карта слагов (Anti-Mage -> antimage и ещё 126 пар) и функции вокруг
// неё лежали прямо в build-hero-pages.js. Как только появился второй сборщик
// страниц героя, копировать пятикилобайтный литерал во второй файл значило
// завести ровно ту расходящуюся пару, о которой предупреждает CLAUDE.md.
